...
function AccountDropDown() {
    return (
        <div className="absolute p-2 right-0 mt-12 mr-2 w-72 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-300 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
            <div className="p-2 flex space-x-2 items-center rounded-lg hover:bg-gray-100 m-1" role="none">
                <Image
            ...
            {/* <div className="flex p-2 space-x-2 items-center hover:rounded-lg hover:bg-gray-100 m-1" role="none">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 rounded-full bg-gray-200 p-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="">
                <div className="flex p-2 space-x-2 items-center justify-between rounded-lg hover:bg-gray-100 m-1" role="none">
