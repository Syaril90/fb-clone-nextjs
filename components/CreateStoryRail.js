    ...
    return (
        <div className="w-28 h-48 flex-col justify-center items-center bg-white rounded-lg">
            ...
            <div className="flex justify-center -mt-4 w-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 bg-blue-500 rounded-full text-white ring-4 ring-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
